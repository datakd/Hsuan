...
# , customItem5__c 公司區域1
# , customItem2__c.accountName 公司名稱1
# , customItem10__c 公司代號2
# , customItem6__c 公司區域2
# , customItem1__c.accountName 公司名稱2
# , customItem8__c 層級說明
...
# data_network = data_network.drop_duplicates('公司代號2')
...
def find_root(company, max_iterations=30):
    count = 0
    while company in parent_map:
        ...
        if count >= max_iterations:
            return None
    return company
data_network["related_company"] = data_network["公司代號2"].apply(lambda x: find_root(x, 30))
...
final_data1 = final_data1.loc[~final_data1['公司代號'].isna()]
